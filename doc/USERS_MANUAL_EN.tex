...
\verb|reboot|            & Watchdog-driven reset via the BCM2711 PM block\\
\verb|pingpong [N]|       & AIPL-style 2-actor cooperative PingPong, N=1..50\\
\verb|procdemo [N]|       & Real 2-process ctxsw demo, N=1..30\\
\verb|usb|               & DWC2 USB HCD diagnostics (Pi 4 only)\\
\verb|rxstat|            & Drain RX ring + show packet / byte counters\\
\verb|pan <dx> <dy>|      & Scroll the virtual 1280×960 desktop viewport\\
\verb|view|              & Show viewport / desktop sizes\\
\verb!autopan [on|off]!   & Toggle demo auto-scroll\\
\bottomrule
\end{tabular}
\end{center}
